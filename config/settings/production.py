...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['my.locuszoom.org'])
...
# Storages. This will automatically add compression and filename hashing/cachebusting for static assets.
