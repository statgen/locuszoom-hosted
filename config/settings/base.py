...
MIGRATION_MODULES = {
    'sites': 'locuszoom_plotting_service.contrib.sites.migrations'
}
...
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',  # Required for admin site usage
...
EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[locuszoom.org]')
...
ADMINS = [
    ("""University of Michigan""", 'locuszoom-service@umich.edu'),
]
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['locuszoom_plotting_service.taskapp.celery.CeleryAppConfig']
if USE_TZ:
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_FILTER_BACKENDS': (
        'locuszoom_plotting_service.api.filters.ExtraQueryParameterValidationFilter',  # JSONAPI + Custom
